...
namespace StrategyGame.Migrations
{
    ...
    [Migration("20190521075831_FixCitiwall")]
    partial class FixCitiwall
    {
            ...
            modelBuilder.Entity("StrategyGame.Models.CityWall", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 3, Point = 100, UpgradeStat = 1.2 }
                    );
                });
            ...
            modelBuilder.Entity("StrategyGame.Models.Elit", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 3, AttackPoint = 5, DefensePoint = 5, Payment = 3, Point = 10, Price = 100, Supply = 2 }
                    );
                });
