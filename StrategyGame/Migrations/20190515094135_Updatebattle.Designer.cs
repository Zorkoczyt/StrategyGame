...
namespace StrategyGame.Migrations
{
    ...
    [Migration("20190515094135_Updatebattle")]
            ...
            modelBuilder.Entity("StrategyGame.Models.CountryUnit", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("CountryUnit");
                });
            ...
            modelBuilder.Entity("StrategyGame.Models.AttackingCountryUnit", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("AttackingCountryUnit");
                });

            modelBuilder.Entity("StrategyGame.Models.DefendingCountryUnit", b =>
                {
                    b.HasBaseType("StrategyGame.Models.CountryUnit");

                    b.Property<int?>("BattleId")
                        .HasColumnName("DefendingCountryUnit_BattleId");

                    b.Property<int?>("CountryId1")
                        .HasColumnName("DefendingCountryUnit_CountryId1");

                    b.HasIndex("BattleId");

                    b.HasIndex("CountryId1");

                    b.ToTable("DefendingCountryUnit");

                    b.HasDiscriminator().HasValue("DefendingCountryUnit");
                });
