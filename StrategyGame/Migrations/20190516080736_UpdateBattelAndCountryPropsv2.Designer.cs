...
namespace StrategyGame.Migrations
{
    ...
    [Migration("20190516080736_UpdateBattelAndCountryPropsv2")]
    partial class UpdateBattelAndCountryPropsv2
    {
            ...
            modelBuilder.Entity("StrategyGame.Models.Country", b =>
                {
                    ...
                    b.Property<int>("AttackBattleId");

                    b.Property<double>("AttackPoint");

                    b.Property<int?>("CountryId");

                    b.Property<int?>("DefendBattleIdId");
            ...
            modelBuilder.Entity("StrategyGame.Models.Battle", b =>
                {
                    b.HasOne("StrategyGame.Models.Country", "AttackingCountry")
                        .WithOne("AttackBattle")
                        .HasForeignKey("StrategyGame.Models.Battle", "AttackingCountryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("StrategyGame.Models.Country", "DefendingCountry")
                        .WithOne("DefendBattle")
                        .HasForeignKey("StrategyGame.Models.Battle", "DefendingCountryId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("StrategyGame.Models.Country", b =>
                {
                    b.HasOne("StrategyGame.Models.Country")
                        .WithMany("AttackableCountries")
                        .HasForeignKey("CountryId");

                    b.HasOne("StrategyGame.Models.Battle", "DefendBattleId")
                        .WithMany()
                        .HasForeignKey("DefendBattleIdId");
