...
namespace StrategyGame.Migrations
{
    ...
    [Migration("20190515092631_UpdateUnitProps")]
    partial class UpdateUnitProps
    {
            ...
            modelBuilder.Entity("StrategyGame.Models.Unit", b =>
                {
                    ...
                    b.Property<int>("UnitGroupingType");
            ...
            modelBuilder.Entity("StrategyGame.Models.Archer", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AttackPoint = 2, DefensePoint = 6, Payment = 1, Price = 50, Supply = 1, UnitGroupingType = 0 }
                    );
                });
            ...
            modelBuilder.Entity("StrategyGame.Models.Elit", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 3, AttackPoint = 5, DefensePoint = 5, Payment = 3, Price = 100, Supply = 2, UnitGroupingType = 0 }
                    );
                });
            ...
            modelBuilder.Entity("StrategyGame.Models.Horseman", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 2, AttackPoint = 6, DefensePoint = 2, Payment = 1, Price = 50, Supply = 1, UnitGroupingType = 0 }
                    );
                });
